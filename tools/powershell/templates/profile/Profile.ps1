...
function prompt {
    ...
    function Initialize-Profile {
        ...
        $ME = whoami.exe
        Write-Host "Hello $ME! Welcome to the matAchu PowerShell profile" -ForegroundColor Green
        Write-Host "Initializing profile..." -ForegroundColor Yellow
        # Display an asci logo with the letters matAachu
        Write-Host "        _   _   _   _   _   _   _  " -ForegroundColor DarkBlue
        Write-Host "       / \ / \ / \ / \ / \ / \ / \ " -ForegroundColor DarkBlue
        Write-Host "      ( m | a | t | A | c | h | u )" -ForegroundColor DarkBlue
        Write-Host "       \_/ \_/ \_/ \_/ \_/ \_/ \_/ " -ForegroundColor DarkBlue
        Write-Host "                                   " -ForegroundColor DarkBlue
        ...
        $modulesConfigPath = "$profilePathFolder\ProfileConfig.json"
        $lastUpdateCheckPath = "$profilePathFolder\ProfileLastUpdateCheck.check"
        $userInput = $null
